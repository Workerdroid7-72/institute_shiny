...
visits_placeholder_card <- function(title, subtitle = NULL) {
  bslib::card(bslib::card_header(shiny::div(shiny::h5(title, class = "mb-0"), if (!is.null(subtitle)) {
...
ui_visits <- bslib::nav_panel(
  ...
  bslib::navset_tab(
    ...
    bslib::nav_panel(
      ...
      bslib::layout_column_wrap(
        width = 1 / 2,
        visits_placeholder_card("Top Pages", "Most viewed pages and page categories"),
        visits_placeholder_card("Entry Pages", "Where visits begin")
      ),
      
      bslib::layout_column_wrap(
        width = 1 / 2,
        visits_placeholder_card("Exit Pages", "Where visits end"),
        visits_placeholder_card("Time on Page", "Which pages hold attention")
      )
    ),
    ...
    bslib::nav_panel(
      ...
      bslib::layout_column_wrap(
        width = 1 / 2,
        visits_placeholder_card("Common Paths", "Frequent page-to-page transitions"),
        visits_placeholder_card("Learning Flow", "Discovery → course → lesson → quiz")
      ),
      
      bslib::layout_column_wrap(
        width = 1,
        visits_placeholder_card("Sankey / Flow Diagram", "Interactive navigation paths")
      )
    ),
    ...
    bslib::nav_panel(
      ...
      bslib::layout_column_wrap(
        ...
        visits_placeholder_card("Repeat Visits", "Users returning more than once"),
        visits_placeholder_card("Retention", "Return behaviour over time")
      ),
      
      bslib::layout_column_wrap(
        width = 1,
        visits_placeholder_card("Cohort Heatmap", "First-use cohorts and subsequent activity")
      )
    ),
    ...
    bslib::nav_panel(
      ...
      bslib::layout_column_wrap(
        width = 1,
        visits_placeholder_card("Visit Detail Table", "Filtered visit-level summary table"),
        visits_placeholder_card("Page Detail Table", "Filtered page-level summary table")
      )
    )
  )
)